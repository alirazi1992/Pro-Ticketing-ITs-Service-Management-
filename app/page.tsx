...
// Initial categories data - synced with client forms
...
// Sample tickets data with some assigned to علی تکنسین and some unassigned for testing
const initialTickets = [
  ...
  // UNASSIGNED TICKETS FOR TESTING ASSIGNMENT
  {
    id: "TK-2024-005",
...
export default function Home() {
  ...
  // ✅ TICKET CREATION FLOW: Client Dashboard → Admin Dashboard
  const handleTicketCreate = (newTicket: any) => {
    setTickets((prev) => [newTicket, ...prev])
  }

  // ✅ TICKET UPDATE FLOW: Admin Assignment → Technician Dashboard → Client/Admin View
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* ✅ CLIENT DASHBOARD: Creates tickets via handleTicketCreate */}
        {user.role === "client" && (
          <ClientDashboard
            tickets={tickets}
        ...
        {/* ✅ TECHNICIAN DASHBOARD: Updates tickets via handleTicketUpdate */}
        {user.role === "engineer" && (
          <TechnicianDashboard tickets={tickets} onTicketUpdate={handleTicketUpdate} currentUser={user} />
        )}

        {/* ✅ ADMIN DASHBOARD: Assigns tickets via handleTicketUpdate */}
        {user.role === "admin" && (
          <AdminDashboard
            tickets={tickets}
